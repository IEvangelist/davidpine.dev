...
In middle school, I taught myself [QuArK (Quake Army Knife)](https://quark.sourceforge.net/) and [Valve Hammer](https://developer.valvesoftware.com/wiki/Valve_Hammer_Editor), diving into level design and 3D architecture. I loved crafting elaborate spaces, meticulously applying textures, and placing light sources to cast perfect shadows. Building these maps was more rewarding than playing them—watching thousands of polygons and entities render down into a single [binary space partition (.bsp)](https://en.wikipedia.org/wiki/Binary_space_partitioning) file was incredibly satisfying.

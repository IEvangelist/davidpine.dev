...
<Tweet id="https://twitter.com/davidpine7/status/695318303326265345" />
...
| Type | Name -- Link |
|:--|:--|
| <strong>OS</strong> | [`Windows 10 IoT Core, "Build 10.0.14393"`](https://developer.microsoft.com/en-us/windows/iot/explore/iotcore) |
| <strong>Platform</strong> | [`Universal Windows Platform (UWP), "UAP 1.0"`](https://msdn.microsoft.com/en-us/windows/uwp/get-started/universal-application-platform-guide) |
...
<YouTube id="https://youtu.be/KOTYW8EioBk" />



<YouTube id="https://youtu.be/PWr1zRBO90o" />

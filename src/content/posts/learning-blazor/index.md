...
tags:
  ...
  - WebAssembly
coverImage:
  src: ./learning-blazor-featured.png
  alt: The Learning Blazor title book cover
---
...
| Media type              | Site                                               |
|-------------------------|----------------------------------------------------|
| [**📖 Paperback (Print)**][paperback] | [**Check it out on  Amazon to pre-order today.**][paperback]    |
| [**💻 eBook (Kindle)**][kindle]  | [**Buy it now on  Amazon Kindle devices.**][kindle] |

...
description: >-
  Use the IAsyncEnumerable<T> interface to stream data from a server to a
  client.
author: David Pine
tags:
  - .NET
...
If you'd rather just see the code, you can see it on the [ GitHub repository `https://github.com/IEvangelist/blazor-azure-openai` ](https://github.com/IEvangelist/blazor-azure-openai).
...
The class is marked as `partial`, as well as the `ScrollIntoView` method. There is a source generator that provides the bridge between the C# and JavaScript code. This is the same idea that I've written about with my side-project named  [**Blazorators**]( "Blazorators") 🤓!
...
![Here's this specific example as rendered on the UI](./example.png "Here's this specific example as rendered on the UI")
...
![The first example is a user prompt and AI response](./response.png "The first example is a user prompt and AI response")

**The next question being asked and the response being generated:**

![The next question being asked and the response being generated](./response-two.png "The next question being asked and the response being generated")

Feel free to share this Tweet, as it was a bit of an inspiration to finish this post...I hope you enjoyed it.

[View post by @IEvangelist](https://x.com/IEvangelist/status/1668970304553582592)
...
Here's the [ GitHub repository link: `https://github.com/IEvangelist/blazor-azure-openai` ](https://github.com/IEvangelist/blazor-azure-openai)

...
```bash
git clone --depth 1 https://github.com/IEvangelist/multiterm-astro my-new-blog && cd my-new-blog
```
...
[![Star History Chart](https://api.star-history.com/svg?repos=IEvangelist/multiterm-astro&type=Date)](https://www.star-history.com/#IEvangelist/multiterm-astro&Date)
